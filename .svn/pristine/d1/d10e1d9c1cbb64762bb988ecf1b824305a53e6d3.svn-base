<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div id="sys_sysuser_add_dialog" class="easyui-dialog" data-options="closed:true,buttons:'#sys_sysuser_add_dialog_buttons',iconCls:
  ...
  <div id="sys_sysuser_add_dialog_buttons">
	<a id="sys_sysuser_add_dialog_buttons_save" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'">保存</a>
 ...
 <script type="text/javascript">
   $(function(){
	  // 保存
	  $("#sys_sysuser_add_dialog_buttons_save").click(function(){
		  $("#sys_sysuser_add_dialog_form").form('submit',{
			  ...
			  success:function(r){
				 ...
				 if($r.success){
					 ...
					 // 关闭
					 $("#sys_sysuser_add_dialog").dialog("close");
